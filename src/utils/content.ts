...
const content: GeneratedContent = {
  ...
  about: {
    ...
    mission: {
      title: "Our Mission",
      text: "Reform UK Erdington Branch exists to implement real reform at both national and local levels across Erdington, Castle Vale, Pype Hayes, Stockland Green, and Kingstanding. We believe in practical solutions that work for all our communities whilst delivering Reform UK's 5-point plan for positive change.",
      points: [
  ...
  join: {
    intro: "Join Reform UK Erdington Branch and be part of the change across Erdington, Castle Vale, Pype Hayes, Stockland Green, and Kingstanding. Together, we can implement our 5-point plan and make a real difference in all our communities.",
