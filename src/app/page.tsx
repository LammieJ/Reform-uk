    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="relative z-20 container mx-auto px-4 py-20">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                href="/join" 
                className="btn bg-white text-reform-primary hover:bg-white/90 text-lg px-8 py-4 rounded-lg font-semibold transition-all transform hover:-translate-y-1 hover:shadow-lg"
              >
                Join Us Today
              </a>
              <a 
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Key Local Issues</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-reform-gray p-8 rounded-xl hover:shadow-xl transition-all transform hover:-translate-y-1">
              <h3 className="text-2xl font-bold mb-4 text-reform-primary">Local Economy</h3>
              <p className="text-gray-600 leading-relaxed">{keyIssues.economy}</p>
            </div>
            <div className="bg-reform-gray p-8 rounded-xl hover:shadow-xl transition-all transform hover:-translate-y-1">
              <h3 className="text-2xl font-bold mb-4 text-reform-primary">Community Safety</h3>
              <p className="text-gray-600 leading-relaxed">{keyIssues.safety}</p>
            </div>
            <div className="bg-reform-gray p-8 rounded-xl hover:shadow-xl transition-all transform hover:-translate-y-1">
              <h3 className="text-2xl font-bold mb-4 text-reform-primary">Housing</h3>
              <p className="text-gray-600 leading-relaxed">{keyIssues.housing}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* About Section */}
      <section id="about" className="py-20 bg-reform-gray">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-4xl font-bold mb-6">Our Vision for Erdington</h2>
              ...
              <a 
                href="/about" 
                className="inline-flex items-center text-reform-primary hover:text-reform-primary/80 font-semibold group"
              >
                Learn More
      ...
      {/* Priorities Section */}
      <section id="priorities" className="py-20 bg-gradient-to-br from-reform-primary to-reform-secondary text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {priorities.map((priority: string, index: number) => (
              <div key={index} className="bg-white/10 p-8 rounded-xl backdrop-blur-sm hover:bg-white/20 transition-all transform hover:-translate-y-1">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-16 text-center">Stay Connected</h2>
          <SocialFeed />
        </div>
      </section>

      {/* Newsletter Section */}
      <section className="py-20 bg-reform-gray">
