...
export default function ContactPage() {
  ...
  const { intro, methods } = content.contact
            ...
            <div>
              ...
              <div className="prose prose-lg">
                {methods.split('\n').map((method, index) => (
                  <div key={index} className="flex items-start mb-8">
                    <div className="text-reform-primary mr-4 mt-1">
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="text-reform-primary hover:text-reform-secondary transition-colors"
                    aria-label="Facebook"
                  >
